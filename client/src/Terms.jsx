function TermsOfUseText () {
    return <>
        <p><span>These Terms and Conditions of Use (&ldquo;T&amp;C&rdquo;) apply to the website located at <span>[https://research-project-main-7b7d74af6ebc.herokuapp.com/]</span> and all associated sites linked to <span>[https://research-project-main-7b7d74af6ebc.herokuapp.com/]</span> (&ldquo;Site&rdquo;). By using the Site, you agree to these T&amp;C. If you do not agree, do not use the Site.</span></p>
