...
function MissingDataWarn ({ open, setOpen }) {
        ...
        <>
            ...
            <div className='fixed left-2/4 top-2/4 -translate-x-1/2 -translate-y-1/2 bg-white inline-block w-10/12 h-fit z-1000 p-5 rounded text-center text-sm'>
                ...
                <div className='text-left font-light text-sm mt-2 mb-4'>
                    <p>Some of your data was lost. This might be caused by page reloading or session expiration. Please start the forms again.</p>
                </div>
                <div className='flex flex-row justify-between'>
                    ...
                    <button onClick={handleConfirmation} className = 'w-28 h-8 bg-green-500 rounded text-white inline text-base font-semibold' type='button'>Start Again</button>
                </div>
            </div>
...
export default MissingDataWarn