function ParticipantInfoText () {
    return <>
        <p><u><span>What is the aim of the study?</span></u></p>
        <p><span >The study aims to validate how different screen (virtual) keyboards impact the presence of frequent repetitive patterns in user-generated passwords and PIN codes.</span></p>
        <p><span >&nbsp;</span></p>
        ...
        <p><span >The study needs to ensure data is collected once from every participant. Because of that reason, the dedicated website at [https://research-project-main-7b7d74af6ebc.herokuapp.com/] uses cookies to detect previous participation. The cookie is represented by a timestamp of your previous data submission stored exclusively in the participant&rsquo;s internet browser (local storage) until manually deleted. The cookie only allows detecting previous openings of the website and does not allow user identification or collected data attribution.</span></p>
        <p><span >&nbsp;</span></p>
        <p><u><span>What actions would you be required to do?</span></u></p>
        <p><span >You will need to open the website [https://research-project-main-7b7d74af6ebc.herokuapp.com/] on your smartphone using an internet browser. Then you will be asked to complete two web forms on this website. The first will require generating a new password that satisfies the described criteria and inputting it twice using the suggested screen keyboard. The second one will require creating a new 4-digit PIN code and inputting it twice using the suggested screen numeric keyboard. The anticipated time to complete both forms is no more than 5 minutes.</span></p>
        <p><span >&nbsp;</span></p>
        <p><u><span>What risks are associated with participation in the study?</span></u></p>
        <p><span >When participating in the study, you are encouraged to strictly adhere to the study recommendations and not use any of your active or previously used passwords. Also, you are strongly recommended not to set a password and PIN code generated within the study participation in your future online activity as they will be processed in plain text by the researcher. Following these warnings will eliminate the risks of sensitive data compromisation.</span></p>
        <p><span >&nbsp;</span></p>
        ...
        <p><span >The study outcomes will be available starting from 01 October 2024. A brief presentation of the key findings will be published on the website [https://research-project-main-7b7d74af6ebc.herokuapp.com/] where the participants took part in the research and will be publicly available up to 31 December 2024.</span></p>
        <p><span >&nbsp;</span></p>
        ...
        <p><span >&nbsp;</span></p>
        <p><u><span>Contact Details.</span></u></p>
        <p><span>Researcher Name: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;Veronika Chupova</span></p>
        <p><span>Researcher Email Address: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</span><a href="mailto:25868705@edgehill.ac.uk"><span>25868705@edgehill.ac.uk</span></a></p>
        <p><span >&nbsp;</span></p>
    </>
}
